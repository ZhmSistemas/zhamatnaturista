...
export default function CategoryForm() {
    ...
    try {
      ...
      if (window.parent !== window) {
        window.parent.postMessage(
          { type: "UPDATE_DASHBOARD_SELECTION", option: "muestracategoria" },
          "*"
        );
      }
  ...
  return (
    <div className="mx-auto w-full p-6">
      <h1 className="mb-6 text-3xl font-bold text-gray-900">Crear Categoría</h1>
      ...
      >
        <div>
          ...
          <input
            ...
            placeholder="Ej: Suplementos, Vitaminas, etc."
