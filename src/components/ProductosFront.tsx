...
import { Package, ChevronRight, Leaf, ShieldCheck, Truck, Star, ShoppingCart } from 'lucide-react'
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-gray-900 mb-4">
              Catálogo <span className="bg-clip-text text-transparent bg-linear-to-r from-green-600 to-emerald-600">Completo</span>
            </h2>
